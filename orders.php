...
<head>
  ...
  <title>Refrigerator Store Ordering System : Orders</title>
  <!-- Bootstrap -->
 ...
 <?php include_once 'nav_bar.php'; ?>
  ...
  <div class="row">
    ...
    <form action="orders.php" method="post" class="form-horizontal">
      ...
      <div class="col-sm-9">
      <input name="oid" type="text" id="oid" placeholder="Order ID" readonly value="<?php if(isset($_GET['edit'])) echo $editrow['fld_order_id']; ?>"> 
      <br><br>
    </div>
  </div>
     <div class="form-group">
      ...
      <div class="col-sm-9">
      <input name="orderdate" type="text"id="orderdateid" placeholder="Order Date" readonly value="<?php if(isset($_GET['edit'])) echo $editrow['fld_order_date']; ?>"> <br><br>
    </div>
  </div>
      <div class="form-group">
 ...
 <div class="row">
    ...
    <table class="table table-striped table-bordered">
      ...
      try {
        $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $sql = "SELECT * FROM tbl_orders_a178796_pt3, tbl_staffs_a178796_pt2, tbl_customers_a178796_pt2 WHERE ";
        $sql = $sql."tbl_orders_a178796_pt3.fld_staff_id = tbl_staffs_a178796_pt2.fld_staff_id and ";
        $sql = $sql."tbl_orders_a178796_pt3.fld_customer_id = tbl_customers_a178796_pt2.fld_customer_id";
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      <nav>
          ...
          try {
            $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            $stmt = $conn->prepare("SELECT * FROM tbl_orders_a178796_pt3");
            $stmt->execute();
            $result = $stmt->fetchAll();
