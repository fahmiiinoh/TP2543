 ...
 ?>
  ...
  <div class="row">
    ...
    <form action="customers.php" method="post">
      ...
      <div class="col-sm-9">
      <input name="cid" type="text"class="form-control" id="customerid" placeholder="Customer ID" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_id']; ?>"> <br>
      </div>
      </div>
      <div class="form-group">
      <label for="name" class="col-sm-3 control-label">Customer Name</label>
      <div class="col-sm-9">
      <input name="name" type="text"class="form-control" id="name" placeholder="Customer Name"  value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_name']; ?>" required> <br>
      </div>
      </div>
      <div class="form-group">
      <label for="phoneno" class="col-sm-3 control-label">Phone Number</label>
      <div class="col-sm-9">
      <input name="phone" type="text"class="form-control" id="phonenumber" placeholder="0##-#######"  value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_phone']; ?>"required> <br>
      </div>
      <div class="form-group">
      <label for="address" class="col-sm-3 control-label">Customer Address</label>
      <div class="col-sm-9">
      <input name="address" type="text"class="form-control" id="address" placeholder="Address"  value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_address']; ?>"> <br>
      </div>
      </div>
      <div class="form-group">
 ...
 <div class="row">
    ...
    <table class="table table-striped table-bordered">
      ...
      $start_from = ($page-1) * $per_page;
        ...
        $stmt = $conn->prepare("select * from tbl_customers_a178796_pt2 LIMIT $start_from, $per_page");
        $stmt->execute();
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      <?php
          try {
            $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            $stmt = $conn->prepare("SELECT * FROM tbl_customers_a178796_pt2");
            $stmt->execute();
            $result = $stmt->fetchAll();
